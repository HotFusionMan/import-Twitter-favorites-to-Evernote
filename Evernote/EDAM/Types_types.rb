  ...
  module EDAM
    module Type
            module PrivilegeLevel
              ...
              MANAGER = 7
              ADMIN = 9
              VALID_VALUES = Set.new([NORMAL, PREMIUM, MANAGER, ADMIN]).freeze
            end
            ...
            class Data
              ...
              FIELDS = {
                BODYHASH => {:type => ::Thrift::Types::STRING, :name => 'bodyHash'},
              ...
              def validate
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field bodyHash is unset!') unless @bodyHash
            ...
            class Accounting
              ...
              FIELDS = {
                UPLOADLIMIT => {:type => ::Thrift::Types::I64, :name => 'uploadLimit'},
                UPLOADLIMITEND => {:type => ::Thrift::Types::I64, :name => 'uploadLimitEnd'},
                UPLOADLIMITNEXTMONTH => {:type => ::Thrift::Types::I64, :name => 'uploadLimitNextMonth'},
                PREMIUMSERVICESTATUS => {:type => ::Thrift::Types::I32, :name => 'premiumServiceStatus', :enum_class => Evernote::EDAM::Type::PremiumOrderStatus},
              ...
              def validate
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field uploadLimit is unset!') unless @uploadLimit
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field uploadLimitEnd is unset!') unless @uploadLimitEnd
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field uploadLimitNextMonth is unset!') unless @uploadLimitNextMonth
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field premiumServiceStatus is unset!') unless @premiumServiceStatus
            ...
            class Resource
              ...
              ::Thrift::Struct.field_accessor self, :guid, :noteGuid, :data, :mime, :width, :height, :duration, :active, :recognition, :attributes, :updateSequenceNum
              FIELDS = {
                GUID => {:type => ::Thrift::Types::STRING, :name => 'guid', :optional => true},
                NOTEGUID => {:type => ::Thrift::Types::STRING, :name => 'noteGuid', :optional => true},
                DATA => {:type => ::Thrift::Types::STRUCT, :name => 'data', :class => Evernote::EDAM::Type::Data},
            ...
            class Note
              ...
              ::Thrift::Struct.field_accessor self, :guid, :title, :content, :contentHash, :contentLength, :created, :updated, :deleted, :active, :updateSequenceNum, :notebookGuid, :tagGuids, :resources, :attributes
              FIELDS = {
                GUID => {:type => ::Thrift::Types::STRING, :name => 'guid', :optional => true},
            ...
            class SavedSearch
              ...
              FIELDS = {
                ...
                FORMAT => {:type => ::Thrift::Types::I32, :name => 'format', :enum_class => Evernote::EDAM::Type::QueryFormat},
                UPDATESEQUENCENUM => {:type => ::Thrift::Types::I32, :name => 'updateSequenceNum', :optional => true}
              }
            ...
            class Ad
              ...
              FIELDS = {
                ...
                WIDTH => {:type => ::Thrift::Types::I16, :name => 'width'},
                HEIGHT => {:type => ::Thrift::Types::I16, :name => 'height'},
              ...
              def validate
                ...
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field height is unset!') unless @height
              end
            ...
            class SharedNotebook
              ...
              FIELDS = {
                ...
                NOTEBOOKMODIFIABLE => {:type => ::Thrift::Types::BOOL, :name => 'notebookModifiable'},
                REQUIRELOGIN => {:type => ::Thrift::Types::BOOL, :name => 'requireLogin'},
                SERVICECREATED => {:type => ::Thrift::Types::I64, :name => 'serviceCreated', :optional => true},
              ...
              def validate
                ...
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field notebookGuid is unset!') unless @notebookGuid
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field email is unset!') unless @email
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field notebookModifiable is unset!') if @notebookModifiable.nil?
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field requireLogin is unset!') if @requireLogin.nil?
              end
