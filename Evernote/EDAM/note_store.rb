                ...
                module NoteStore
                  module NoteStore
                    class Client
                      ...
                      def getSyncChunk(authenticationToken, afterUSN, maxEntries)
                        send_getSyncChunk(authenticationToken, afterUSN, maxEntries)
                        return recv_getSyncChunk()
                      end

                      def send_getSyncChunk(authenticationToken, afterUSN, maxEntries)
                        send_message('getSyncChunk', GetSyncChunk_args, :authenticationToken => authenticationToken, :afterUSN => afterUSN, :maxEntries => maxEntries)
                      end
                      ...
                      def findNoteCounts(authenticationToken, filter)
                        send_findNoteCounts(authenticationToken, filter)
                        return recv_findNoteCounts()
                      end

                      def send_findNoteCounts(authenticationToken, filter)
                        send_message('findNoteCounts', FindNoteCounts_args, :authenticationToken => authenticationToken, :filter => filter)
                      end
                      ...
                      def getNote(authenticationToken, guid, withContent)
                        send_getNote(authenticationToken, guid, withContent)
                        return recv_getNote()
                      end

                      def send_getNote(authenticationToken, guid, withContent)
                        send_message('getNote', GetNote_args, :authenticationToken => authenticationToken, :guid => guid, :withContent => withContent)
                      end
                      ...
                      def getResource(authenticationToken, guid, withData, withRecognition, withAttributes)
                        send_getResource(authenticationToken, guid, withData, withRecognition, withAttributes)
                        return recv_getResource()
                      end

                      def send_getResource(authenticationToken, guid, withData, withRecognition, withAttributes)
                        send_message('getResource', GetResource_args, :authenticationToken => authenticationToken, :guid => guid, :withData => withData, :withRecognition => withRecognition, :withAttributes => withAttributes)
                      end
                      ...
                      def getResourceByHash(authenticationToken, noteGuid, contentHash, withData, withRecognition)
                        send_getResourceByHash(authenticationToken, noteGuid, contentHash, withData, withRecognition)
                        return recv_getResourceByHash()
                      end

                      def send_getResourceByHash(authenticationToken, noteGuid, contentHash, withData, withRecognition)
                        send_message('getResourceByHash', GetResourceByHash_args, :authenticationToken => authenticationToken, :noteGuid => noteGuid, :contentHash => contentHash, :withData => withData, :withRecognition => withRecognition)
                      end
                    ...
                    class Processor
                      ...
                      def process_getSyncChunk(seqid, iprot, oprot)
                        ...
                        begin
                          result.success = @handler.getSyncChunk(args.authenticationToken, args.afterUSN, args.maxEntries)
                        rescue Evernote::EDAM::Error::EDAMUserException => userException
                          result.userException = userException
                        rescue Evernote::EDAM::Error::EDAMSystemException => systemException
                          result.systemException = systemException
                      ...
                      def process_findNoteCounts(seqid, iprot, oprot)
                        ...
                        begin
                          result.success = @handler.findNoteCounts(args.authenticationToken, args.filter)
                        rescue Evernote::EDAM::Error::EDAMUserException => userException
                          result.userException = userException
                        rescue Evernote::EDAM::Error::EDAMSystemException => systemException
                          result.systemException = systemException
                      ...
                      def process_getNote(seqid, iprot, oprot)
                        ...
                        begin
                          result.success = @handler.getNote(args.authenticationToken, args.guid, args.withContent)
                        rescue Evernote::EDAM::Error::EDAMUserException => userException
                          result.userException = userException
                        rescue Evernote::EDAM::Error::EDAMSystemException => systemException
                          result.systemException = systemException
                      ...
                      def process_getResource(seqid, iprot, oprot)
                        ...
                        begin
                          result.success = @handler.getResource(args.authenticationToken, args.guid, args.withData, args.withRecognition, args.withAttributes)
                        rescue Evernote::EDAM::Error::EDAMUserException => userException
                          result.userException = userException
                        rescue Evernote::EDAM::Error::EDAMSystemException => systemException
                          result.systemException = systemException
                      ...
                      def process_getResourceByHash(seqid, iprot, oprot)
                        ...
                        begin
                          result.success = @handler.getResourceByHash(args.authenticationToken, args.noteGuid, args.contentHash, args.withData, args.withRecognition)
                        rescue Evernote::EDAM::Error::EDAMUserException => userException
                          result.userException = userException
                        rescue Evernote::EDAM::Error::EDAMSystemException => systemException
                          result.systemException = systemException
                    ...
                    class GetSyncChunk_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :afterUSN, :maxEntries
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                    ...
                    class FindNoteCounts_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :filter
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        FILTER => {:type => ::Thrift::Types::STRUCT, :name => 'filter', :class => Evernote::EDAM::NoteStore::NoteFilter}
                      }
                    ...
                    class GetNote_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :guid, :withContent
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        GUID => {:type => ::Thrift::Types::STRING, :name => 'guid'},
                    ...
                    class GetResource_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :guid, :withData, :withRecognition, :withAttributes
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        GUID => {:type => ::Thrift::Types::STRING, :name => 'guid'},
                    ...
                    class GetResourceByHash_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :noteGuid, :contentHash, :withData, :withRecognition
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        NOTEGUID => {:type => ::Thrift::Types::STRING, :name => 'noteGuid'},
